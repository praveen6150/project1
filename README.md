...
## 🛠️ Application Features Matrix

Here is the structured breakdown of the image processing algorithms available or in active development within the suite:

### 📥 Point Processing Framework
```text
Point Process/
